...
/**
 *  Food which has a rating, can move around in a panel in random directions.
 *  It must run as a thread
 * @author sehall
 */
public class Food implements Runnable, Comparable<Food> {
	...
	public boolean isAlive() { // added myself 
		return alive;
	}
	@Override
	...
	public boolean equals(Object o) {
		if(o instanceof Food) {
			Food f = (Food)o;
			return (f.getRating() == rating && f.getColour() == c);
		}
		else return false;
	}
}